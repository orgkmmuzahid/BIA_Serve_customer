...
class _SlideToCallActionState extends State<SlideToActionButton>
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Container(
        decoration: BoxDecoration(color: AppColors.serfeceBG, borderRadius: BorderRadius.circular(50), border: Border.all(color: AppColors.serfeceBG)),
        height: 70,
        child: SizedBox(
          height: 120,
    ...
    return Positioned(
              ...
              child: AnimatedBuilder(
                ...
                builder: (_, __) => Transform.translate(
                  ...
                  child: const Icon(Icons.double_arrow, color: AppColors.primaryButton),
                ),
              ),
            );
  }
