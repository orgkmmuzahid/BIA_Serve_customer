  ...
  Widget build(BuildContext context) => SizedBox(
    ...
    child: Column(
      children: [
        ...
        CommonText(text: model.name, style: theme.textTheme.bodyMedium?.copyWith(color: AppColors.primaryText, fontWeight: FontWeight.bold), overflow: TextOverflow.visible,),
      ],
    ),
  );
}
