  ...
  SizedBox _vendorsServiceList(
    ...
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (_, index) {
          final item = vendorSourcingController.serviceFee.entries.elementAt(
            index,
          );
          final bool isSelected =
              item.key == vendorSourcingController.selectedServiceFee.key;
          return Padding(
            ...
            child: CommonButton(
              ...
              titleSize: 19,
              titleColor:
                  isSelected ? AppColors.primaryColor : AppColors.primaryText,
              borderColor:
                  isSelected ? AppColors.primaryColor : AppColors.stock2,
