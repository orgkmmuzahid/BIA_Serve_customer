...
class TrackingOrderScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Scaffold(
    appBar: const CommonAppBar(
      title: AppString.percelTracking,
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                10.height,
                CommonTimeline(
                  timeline: trackingOrderController.trackingOrderModel.timeline,
                ),
              ],
            ),
          ),
            ...
            children: [
              ...
              CommonRichText(
                richTextContent: [
                  ...
                  CommonSimpleRichTextContent(
                    text: '${AppString.senderName} : ${model.senderName}\n',
                    style: theme.textTheme.titleSmall,
                  ),
                  CommonSimpleRichTextContent(
                    text: '${AppString.phoneNumber} : ${model.phoneNumber}\n',
                    style: theme.textTheme.titleSmall,
                  ),
                  CommonSimpleRichTextContent(
                    text: '-------------------------------\n',
                  ...
                  CommonSimpleRichTextContent(
                    text: '${AppString.reciverName} : ${model.reciverName}\n',
                    style: theme.textTheme.titleSmall,
                  ),
                  CommonSimpleRichTextContent(
                    text:
                        '${AppString.phoneNumber} : ${model.reciverPhoneNumber}\n',
                    style: theme.textTheme.titleSmall,
                  ),
                  CommonSimpleRichTextContent(
                    text: '${AppString.address} : ${model.address}\n',
                    style: theme.textTheme.titleSmall,
                  ),
                  CommonSimpleRichTextContent(
