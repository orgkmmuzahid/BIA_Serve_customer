...
class PurchaseDeliveryModel {
  ...
  factory PurchaseDeliveryModel.fromMap(Map<String, dynamic> map) {
    return PurchaseDeliveryModel(
      ...
      deliveryAddress: map['deliveryAddress'] != null ? map['deliveryAddress'] as String : null,
      productDescription: map['productDescription'] != null ? map['productDescription'] as String : null,
      serviceFee: map['serviceFee'] != null ? map['serviceFee'] as double : null,
  ...
  factory PurchaseDeliveryModel.fromJson(String source) => PurchaseDeliveryModel.fromMap(json.decode(source) as Map<String, dynamic>);
