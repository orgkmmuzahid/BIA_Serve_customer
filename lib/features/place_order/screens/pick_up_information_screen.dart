...
import 'package:bai_serve/features/place_order/widgets/coupon_section_widget.dart';
import 'package:bai_serve/features/place_order/widgets/door_to_door_delivery_type_widget.dart';
import 'package:bai_serve/features/place_order/widgets/pickup_information_form_widget.dart';
...
class PickUpInformationScreen extends StatelessWidget {
  PickUpInformationScreen({super.key})
    : title =
          (Get.arguments == null
              ? {}
              : Get.arguments as Map<String, dynamic>)['title'] ??
