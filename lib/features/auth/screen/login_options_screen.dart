  ...
  Widget build(BuildContext context) => Scaffold(
    body: Padding(
      ...
      child: Column(
        ...
        children: [
          180.height,
          const Center(child: CommonImage(imageSrc: AppImages.appsIcon, width: 124, height: 107)),
          50.height,
          leftAlignButton(
          ...
          20.height,
          leftAlignButton(tilte: AppString.loginWithGoogle, image: AppImages.iconGoogle),
          20.height,
          leftAlignButton(tilte: AppString.loginWithFacebook, image: AppImages.iconFacebook),
        ],
      ),
    ),
  );

  Widget leftAlignButton({required String tilte, required String image, VoidCallback? onTap}) => CommonButton(
    titleText: tilte,
    onTap: onTap,
    ...
    icon: Padding(padding: const EdgeInsets.only(left: 40.5, right: 20), child: CommonImage(imageSrc: image)),
  );
}
