...
class AppRoutes {
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: signUp, page: SignUpScreen.new),
    GetPage(name: verifyUser, page: () => const VerifyUserScreen()),
    GetPage(name: signIn, page: SignInScreen.new),
    GetPage(name: forgotPassword, page: ForgetPasswordScreen.new),
    GetPage(name: home, page: HomeScreen.new),
    GetPage(name: placeOrder, page: PlaceOrderScreen.new),
    GetPage(name: pickupInformation, page: PickUpInformationScreen.new),
    ...
    GetPage(name: checkout, page: CheckoutScreen.new),
    GetPage(name: bulkOrder, page: BulkOrderScreen.new),
    GetPage(name: doorToDoorPickup, page: DoorToDoorPickupScreen.new),
    GetPage(name: negotiationAssistance, page: NegotiationAssistanceScreen.new),
    GetPage(name: chat, page: ChatScreen.new),
    GetPage(name: bulkOrderDetails, page: BulkOrderDetailsScreen.new),
    GetPage(name: purchaseDelivery, page: () => const PurchaseDeliveryScreen()),
    GetPage(name: myOrder, page: MyOrderScreen.new),
